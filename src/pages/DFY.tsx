      ...
      <section className="container mx-auto px-6 py-16">
        <div className="max-w-4xl mx-auto bg-background/80 backdrop-blur-md rounded-2xl p-8 md:p-12 border border-border/50">
          ...
          <div className="space-y-10">
            <div className="flex gap-6 items-start">
              <div className="text-5xl font-bold text-accent/40">01</div>
              <div className="flex-1">
                <h3 className="text-2xl font-bold text-foreground mb-3">Discovery: From Idea to Exact Game Plan</h3>
                <p className="text-muted-foreground mb-4">We don't waste your time with vague calls.</p>
                <ul className="space-y-4 text-muted-foreground">
                  <li>
            ...
            <div className="flex gap-6 items-start">
              <div className="text-5xl font-bold text-accent/40">02</div>
              <div className="flex-1">
                <h3 className="text-2xl font-bold text-foreground mb-3">Build: Design, Develop, Tighten</h3>
                <p className="text-muted-foreground mb-4">Now we execute—fast, structured, and transparent.</p>
                <ul className="space-y-4 text-muted-foreground">
                  <li>
            ...
            <div className="flex gap-6 items-start">
              <div className="text-5xl font-bold text-accent/40">03</div>
              <div className="flex-1">
                <h3 className="text-2xl font-bold text-foreground mb-3">Launch & Beyond: Live, Backed, Supported</h3>
                <p className="text-muted-foreground mb-4">Going live is handled end-to-end.</p>
                <ul className="space-y-4 text-muted-foreground">
                  <li>
