...
// ====================================
// ====================================
// DESIGN RULES - Hardcoded constant (NO FILE READING)
// ====================================
const DESIGN_RULES = `
====================================
## DESIGN RULES - MANDATORY COMPLIANCE
====================================

### TYPOGRAPHY
- Short, punchy headlines (max 8 words)
- Benefit-driven, NOT feature-driven
- No generic marketing fluff

### LAYOUT
- Use bento-grids and split-screens where appropriate
- Avoid stacking text without visual breaks
- Generous whitespace (py-16 minimum between sections)

### CONTENT
- Every headline must answer "What's in it for me?"
- Write like a human, not a marketing robot
- Industry-specific terminology ONLY (no SaaS terms for service businesses)
...
### CRITICAL - NICHE MATCHING
ALWAYS match content to the detected industry:
- Gym/Fitness: Classes, trainers, membership, equipment
- Restaurant: Menu, reservations, chef, ambiance
- Plumber: Emergency service, repairs, quotes
- Salon: Stylists, services, appointments
- NEVER use SaaS terms (dashboards, analytics, API) for non-tech businesses
